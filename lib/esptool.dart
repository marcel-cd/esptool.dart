...
import 'src/esptool_platform_interface.dart';

export 'src/common.dart';
export 'src/esptool_android.dart';
export 'src/esptool_desktop.dart';

EsptoolPlatform get _platform => EsptoolPlatform.instance;
...
class Esptool {
  ...
  static Future<bool> send(List<int> data) => _platform.send(data);
